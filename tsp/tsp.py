...
def main(tour_out_file, iterations, operator, holes):
    ...
    verbose=False
    out_file_name=tour_out_file
    max_iterations=int(iterations)
    if operator == 'swapped_cities':
        move_operator=swapped_cities
    elif operator == 'reversed_sections':
        move_operator=reversed_sections
    ...
    if out_file_name:
        write_tour_to_img(coords,best,'%s: %f'%("Jessiro ",score),file(out_file_name,'w'))
